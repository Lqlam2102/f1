Important: add a line to your hosts file or Download and Run with run as admin Block Host.cmd:
1.2.3.4 bs.studycoder.com

- For windows : Copy BetterIntelliJ-1.20.jar or BetterIntelliJ-1.19.jar to Drive C:
- Run the IDE and evalutate for free
- Go to Tab Configure > Plugins
- Choose Install Plugin from disk & choose c:/BetterIntelliJ-1.20.jar ( do this twice )
- Click Save ( Don't restart if prompted )
- Click IDE menu "Configure" or "Help" -> "Edit Custom VM Options..."
- Append "-javaagent:${JetbrainsIdesCrackPath}" to end line where ${JetbrainsIdesCrackPath} is the location of plugin as bellow :

mac:
-javaagent:/Users/neo/BetterIntelliJ-1.20.jar ( example )

linux:
-javaagent:/home/neo/BetterIntelliJ-1.20.jar ( example )

windows:
-javaagent:c:/BetterIntelliJ-1.20.jar

- Restart IDE
- Go to Configure > Manage License.
